...
const photosTab = () => {
  ...
  photosSection.innerHTML = `
    ...
    <img src="../src/images/pexels-picjumbocom-225228.jpg" alt="" class="photo">
    <img src="../src/images/pexels-helena-lopes-1015568.jpg" alt="" class="photo">
    <img src="../src/images/pexels-pixabay-262978.jpg" alt="" class="photo">
    <img src="../src/images/pexels-helena-lopes-693269.jpg" alt="" class="photo">
